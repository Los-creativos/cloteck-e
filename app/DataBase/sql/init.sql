...
CREATE TABLE "Attribute" (
    ...
    CONSTRAINT "Attribute_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "Product"("product_id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "Attribute_size_id_fkey" FOREIGN KEY ("size_id") REFERENCES "Size"("size_id") ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT "Attribute_color_id_fkey" FOREIGN KEY ("color_id") REFERENCES "Color"("color_id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "Shipment" (
    ...
    CONSTRAINT "Shipment_order_id_fkey" FOREIGN KEY ("order_id") REFERENCES "Order"("order_id") ON DELETE CASCADE ON UPDATE CASCADE
);
